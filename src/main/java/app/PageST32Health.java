...
public class PageST32Health implements Handler {

    // URL of this page relative to http://localhost:7001/
    public static final String URL = "/page6_Health.html";

    // Name of the Thymeleaf HTML template page in the resources folder
    private static final String TEMPLATE = ("PageST32Health.html");
    ...
    public void handle(Context context) throws Exception {
       ...
       if (location == null && indigenousStatus == null && sex == null && condition == null && limit == null) {
            ...
            String html = "<div class = 'introduction-results-wrapper'>";
            html = html + "<h1>Top " + limit + " Most Similar LGAs to " + location + " in Long-Term Health Conditions Dataset</h1>";
